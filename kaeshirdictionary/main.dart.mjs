...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1268: () => globalThis.window.navigator.userAgent,
      _1270: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1271: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1272: (x0,x1) => x0.createElement(x1),
      _1279: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1280: (x0,x1) => x0.canShare(x1),
      _1281: (x0,x1) => x0.share(x1),
      _1283: (x0,x1,x2) => ({files: x0,title: x1,text: x2}),
      _1284: (x0,x1) => ({files: x0,text: x1}),
      _1285: (x0,x1) => ({files: x0,title: x1}),
      _1286: x0 => ({files: x0}),
      _1287: (x0,x1) => ({title: x0,text: x1}),
      _1290: x0 => x0.remove(),
      _1293: () => globalThis.Notification.requestPermission(),
      _1297: x0 => globalThis.firebase_remote_config.fetchAndActivate(x0),
      _1308: x0 => globalThis.firebase_remote_config.getRemoteConfig(x0),
      _1309: x0 => x0.decode(),
      ...
      _1329: x0 => globalThis.firebase_core.getApp(x0),
      _1330: () => globalThis.firebase_core.getApp(),
      _1334: x0 => x0.settings,
      _1337: (x0,x1) => x0.defaultConfig = x1,
      _1343: (x0,x1) => x0.minimumFetchIntervalMillis = x1,
      _1345: (x0,x1) => x0.fetchTimeoutMillis = x1,
      _1370: () => globalThis.firebase_core.SDK_VERSION,
      _1376: x0 => x0.apiKey,
      _1378: x0 => x0.authDomain,
      _1380: x0 => x0.databaseURL,
      _1382: x0 => x0.projectId,
      _1384: x0 => x0.storageBucket,
      _1386: x0 => x0.messagingSenderId,
      _1388: x0 => x0.measurementId,
      _1390: x0 => x0.appId,
      _1392: x0 => x0.name,
      _1393: x0 => x0.options,
      _1394: (x0,x1) => x0.debug(x1),
      _1395: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1395(f,arguments.length,x0) }),
      _1396: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1396(f,arguments.length,x0,x1) }),
      _1397: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1398: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1399: (x0,x1) => x0.createScriptURL(x1),
      _1400: (x0,x1,x2) => x0.createScript(x1,x2),
      _1401: (x0,x1) => x0.appendChild(x1),
      _1402: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1402(f,arguments.length,x0) }),
      _1403: () => globalThis.removeSplashFromWeb(),
      _1405: Date.now,
      ...
      _1443: Object.is,
      _1444: (a, i) => a.push(i),
      _1445: (a, i) => a.splice(i, 1)[0],
      _1447: (a, l) => a.length = l,
      _1448: a => a.pop(),
      _1449: (a, i) => a.splice(i, 1),
      _1450: (a, s) => a.join(s),
      _1451: (a, s, e) => a.slice(s, e),
      _1452: (a, s, e) => a.splice(s, e),
      _1453: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1454: a => a.length,
      _1456: (a, i) => a[i],
      _1457: (a, i, v) => a[i] = v,
      ...
      _1460: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      ...
      _1464: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1465: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      ...
      _1557: x0 => x0.trustedTypes,
      _1558: (x0,x1) => x0.text = x1,
      _1568: (s, m) => {
        try {
      ...
      _1627: (o, p) => o[p],
      _1628: (o, p, v) => o[p] = v,
      _1629: (o, p) => delete o[p],
      _1630: x0 => x0.random(),
      _1631: (x0,x1) => x0.getRandomValues(x1),
      _1632: () => globalThis.crypto,
      ...
      _2412: x0 => x0.error,
      _2414: (x0,x1) => x0.src = x1,
      _2419: (x0,x1) => x0.crossOrigin = x1,
      _2422: (x0,x1) => x0.preload = x1,
      _2426: x0 => x0.currentTime,
      _2427: (x0,x1) => x0.currentTime = x1,
      _2428: x0 => x0.duration,
      _2433: (x0,x1) => x0.playbackRate = x1,
      _2442: (x0,x1) => x0.loop = x1,
      _2446: (x0,x1) => x0.volume = x1,
      _2463: x0 => x0.code,
      _2464: x0 => x0.message,
      _3045: (x0,x1) => x0.type = x1,
      _3053: (x0,x1) => x0.crossOrigin = x1,
      _3055: (x0,x1) => x0.text = x1,
      _3512: () => globalThis.window,
      _3574: x0 => x0.navigator,
      _3836: x0 => x0.trustedTypes,
      _3838: x0 => x0.localStorage,
      _3961: x0 => x0.userAgent,
      _3967: x0 => x0.onLine,
      _4169: x0 => x0.length,
      _5557: x0 => x0.destination,
      _6112: x0 => x0.signal,
      ...
      _8650: x0 => x0.body,
      _12278: x0 => x0.name,
      _12279: x0 => x0.message,
      _12995: () => globalThis.console,
      _13023: x0 => x0.name,
      _13024: x0 => x0.message,
      _13025: x0 => x0.code,
...
"TransitionRoute",
"DartPerformanceMode.",
"Data is being loaded for the first time and will be available offline",
"Data is being synced with the server",
...
"Today's Words",
"Data Contributors",
"assets/markdown/db_contributors.md",
"Fontisto",
...
"Izan Majeed",
"Developer",
"https://www.buymeacoffee.com/izan.majeed",
...
"WrapAlignment.",
"swipe",
"https://github.com/izan-majeed/Kaeshir-Database",
"https://youtu.be/Xh7HTC6Paf4?si=lJDl3f8dZs_Txo71",
"https://in.linkedin.com/in/izan-majeed",
"\n\nKariv teli download:\n",
...
"https://script.google.com/macros/s/AKfycbyaPvR3K74c45oRolZ6UwlQL5Bxg4YjZU4bqVvoOZDuMo7JTpE62lY85E6dgw6E_kBypQ/exec",
"_snapshot",
"Fg==",
"Fw==",
"charset",
...
"ConnectionState.",
"Important Note",
"The responsibility for these events is attributed variously to security forces and militant groups, with accountability often hindered by political and legal factors. The sources documenting these incidents are largely credible human rights and investigative organizations, though all sources require critical consideration of context and potential biases due to the highly polarized, conflicted environment in Kashmir.",
"This is why multiple types of sources—official, independent and survivor accounts—are needed to form an informed understanding of such complex and contested events.",
"italic",
"Police fired on protesters outside Srinagar's Central Jail.",
"At least 22 unarmed civilians were killed.",
"Jul 13, 1931",
"https://crescent.icit-digital.org/articles/july-13-kashmir-martyrs-day",
"Kashmir Martyrs' Day",
"British India was partitioned into India and Pakistan",
"Maharaja Hari Singh initially sought independence for J&K, but later faced an invasion.",
"Aug, 1947",
"https://www.bbc.com/news/world-south-asia-16069078",
"Princely-State Decision",
"Pashtun tribal militias invaded, with violence in Baramulla and other areas.",
"Maharaja Hari Singh signed the Instrument of Accession to India on 26 October 1947.",
"Indian troops were airlifted to Srinagar, leading to the First Indo-Pak War.",
"Anti-Maharaja forces established a provisional government in parts of western Kashmir (Azad Kashmir).",
"Oct, 1947",
"https://www.satp.org/satporgtp/countries/india/document/papers/text_of_india%27s_complaint_to_security_council.htm",
"Tribal Invasion",
"India referred the Kashmir issue to the UN Security Council.",
"Resolution 47 proposed a ceasefire and plebiscite framework (never implemented).",
"A UN-brokered CFL is drawn, later becoming the Line of Control (LOC).",
"Jan, 1948",
"https://www.satp.org/satporgtp/countries/india/document/papers/complaint_2_security_council_1948.htm",
"Kashmir Dispute to UN",
"China defeats India and takes control of Aksai Chin becoming a third stakeholder in the dispute.",
"Oct, 1962",
"https://www.cfr.org/in-brief/china-india-border-dispute-what-know",
"Sino-Indian War",
"Begins in the Rann of Kutch spreads to Kashmir. Ends in a UN-mandated ceasefire with no major border changes.",
"Administrative titles in J&K were aligned with the rest of India e.g. Sadr-e-Riyasat to Governor, Prime Minister to Chief Minister.",
"Aug, 1965",
"https://abhipedia.abhimanu.com/Article/IAS/NzQyMTQEEQQVV/J-K-Prime-Minister-and-Sadr-e-Riyasat-Indian-Polity-IAS",
"Second Indo-Pak War",
"India supports the creation of Bangladesh, Kashmir remains a secondary battleground.",
"The Simla Agreement formalizes the LOC and commits both nations to bilateral talks.",
"Dec, 1971",
"https://niu.edu.in/sla/online-classes/THE-KASHMIR-DISPUTE-AND-THE-SIMLA-AGREEMENT.pdf",
"Third Indo-Pak War",
"Sheikh Abdullah returned to power after an accord with PM Indira Gandhi.",
"Accepted Indian constitutional framework, abandoning the plebiscite demand which was a major betrayal for the people of Kashmir.",
"Feb 24, 1975",
"https://www.satp.org/satporgtp/countries/india/states/jandk/documents/papers/sheikh_indira_accord_1975.htm",
"Indira–Sheikh Accord",
"The Gawkadal Massacre occurred at the Gawkadal bridge in Srinagar, where Indian paramilitary troops of the Central Reserve Police Force (CRPF) opened fire on a group of unarmed Kashmiri protesters.",
"An estimated 50-100 civilians were killed either by gunfire or by drowning after jumping into the Jhelum River to escape the shooting.",
"No government investigation was ever conducted and no one was held accountable for the killings.",
"Jan 21, 1990",
"https://standwithkashmir.org/gowkadal-massacre/",
"Gawkadal Massacre",
"Armed Forces Special Powers Act (AFSPA) is imposed in J&K.",
"This law grants special powers to the armed forces to kill anyone suspected of being a militant, leading to widespread allegations of human rights abuses.",
"Jul 5, 1990",
"https://www.amnesty.org/ar/wp-content/uploads/2021/08/asa200252005en.pdf",
"AFSPA Imposition",
"The incident occurred in the twin villages of Kunan and Poshpora in Kupwara district, Kashmir.",
"During a search operation by Indian security forces (CRPF, BSF and Indian Army's 4th Rajputana Rifles), many women in the villages were gang-raped.",
"Initial FIRs recorded 23 cases, but human rights groups estimate the number of victims to be as high as 100.",
"The men in the village were detained and subjected to harsh interrogations and torture while women were sexually assaulted in their homes.",
"The incident has been widely condemned by international human rights organizations including Human Rights Watch and the U.S. Department of State who found credible evidence supporting the incident.",
"Survivors and activists have been fighting for justice for more than three decades, but the case remains unresolved with no accountability or criminal prosecution, fueling continued demands for transparency and redress in Kashmir.",
"Feb 23, 1991",
"https://www.bbc.com/news/world-asia-41268906",
"Kunan Poshpora Mass Rape",
"The Indian Border Security Force (BSF) went on a rampage, killing at least 43 to 57 civilians. The massacre included indiscriminate firing on civilians, dragging people out of their homes to shoot them at point blank range and burning shops and houses with people inside.",
"The incident was reportedly triggered by an earlier attack on BSF personnel by militants in the area. Following this, the BSF retaliated with extreme violence, setting fire to around 400 buildings, including homes and shops, causing extensive destruction.",
"The Indian government initially claimed the deaths resulted from a crossfire and a militant explosives blast, but later acknowledged that the BSF had opened fire on civilians. A judicial inquiry was ordered, BSF officers were suspended and compensation was announced for victims' families. Still, no full accountability or transparent justice has been realized and the event remains a significant example of human rights violations in Kashmir.",
"The massacre sparked widespread protests despite curfews, with extensive condemnation from human rights organizations such as Amnesty International and Human Rights Watch, which documented extrajudicial killings and human rights abuses by paramilitary forces in Kashmir.",
"Jan 6, 1993",
"https://www.amnesty.org/es/wp-content/uploads/2021/06/asa200171993en.pdf",
"Sopore Massacre",
"The Indian Border Security Force (BSF) opened fire indiscriminately on a peaceful procession of protesters demanding an end to the Hazratbal mosque siege. At least 37–51 civilians were killed and over 70–200 were injured according to various reports, with eyewitnesses and human rights organizations documenting that the firing was unprovoked and lasted for several minutes.",
"Multiple official inquiries, including those by the Indian government and the National Human Rights Commission, found that the BSF fired without provocation and indicted several officers, but all were later acquitted in a nonpublic trial. No one has been held accountable and the victims’ families continue to await justice decades later, as attempts to review the trial transcripts were blocked by the government.",
"The massacre is remembered as one of the worst atrocities in Kashmir’s conflict, sparking international outrage and condemnation by organizations such as Human Rights Watch and Amnesty International. It intensified grievances in the region and remains a symbol of unaddressed human rights abuses.",
"Oct 22, 1993",
"https://lfkashmir.com/wp-content/uploads/2023/10/bijbehara-masacre-2.pdf",
"Bijbehara Massacre",
"Indian Army fired indiscriminately on civilians in Kupwara district, Kashmir. At least 27 people were killed, including traders, government employees, police officers and civilians, with dozens more injured. The shootings occurred a day after the local population observed a shutdown in defiance of Army warnings against marking Republic Day with a strike.",
"Eyewitness reports describe troops targeting people as revenge for observing the shutdown, with firing lasting nearly an hour and troops preventing aid to the wounded. The CID confirmed the firing was unprovoked and unjustified, but the Army invoked the Armed Forces Special Powers Act (AFSPA) to block prosecution and the case was closed without any accountability despite police registering FIRs for murder and attempted murder.",
"The incident is remembered as one of the darkest days in Kupwara's history and remains unaddressed, with continued demands for justice from survivors and human rights activists. It has been documented in international and domestic human rights reports as a grave example of impunity for security forces in Kashmir.",
"Jan 27, 1994",
"https://kashmirawareness.org/1994-kupwara-massacre-27-civilians-shot-dead-for-observing-shutdown-on-jan-26/",
"Kupwara Massacre",
"In Ganderbal, 23 Kashmiri Hindus including men, women and children were killed by militants.",
"The attackers, dressed in military uniforms, entered homes, gathered the families and shot them.",
"Despite investigations and widespread condemnation, no one has been held accountable.",
"The tragedy deepened the sense of insecurity among the Kashmiri Hindu minority which Kashmiri independence parties, such as Hurriyet, have also condemned.",
"Jan 25, 1998",
"https://1997-2001.state.gov/briefings/statements/1998/ps980127a.html",
"Wandhama Massacre",
"Unidentified gunmen dressed in Indian Army uniforms stormed the Sikh village of Chittisinghpura in Anantnag district, Kashmir, rounding up 35–36 Sikh men and shooting them dead outside two gurdwaras. This was the first massacre targeting Sikhs in Kashmir, committed on the eve of US President Bill Clinton's visit to India.",
"The attackers arrived at night during a local festival, lined up the male villagers and fired at point-blank range. Although Indian authorities blamed Pakistan-based militant groups Lashkar-e-Taiba and Hizbul Mujahideen, no perpetrators were positively identified and some survivors and human rights groups questioned the official narrative, noting the attackers' use of Indian Army uniforms and nationalist slogans.",
"The massacre deeply shocked the Sikh community, leading to widespread protests, demands for justice and continued controversy regarding responsibility and motives. The event is recognized as a pivotal and tragic chapter in Kashmir’s conflict, with unresolved questions and ongoing calls for transparent investigation",
"Mar 20, 2000",
"https://www.baaznews.org/p/chittisinghpura-massacre-india-role-sikhs",
"Chittisingpora Massacre",
"Personnel from the Indian Army's 7 Rashtriya Rifles conducted a joint operation in Pathribal, Anantnag, Kashmir, resulting in the killing of five men in what was officially claimed as an encounter with foreign militants responsible for the Chittisinghpora Sikh massacre. However, investigations and public protests revealed that the victims were innocent local civilians who had been abducted days earlier and the incident was a staged, or fake, encounter.",
"Local outrage escalated after the charred bodies were identified by families, prompting protests and a subsequent inquiry. DNA evidence and a CBI investigation conclusively established that the men killed were not militants, but ordinary villagers abducted prior to the encounter. Despite this, the Army closed its investigation, citing lack of evidence against the personnel involved and legal barriers (like the Armed Forces Special Powers Act and Army Act) prevented prosecution, leaving the victims' families without justice.",
"The Pathribal Fake Encounter is widely recognized as a grave human rights violation and an emblem of impunity for security forces in Kashmir. It was condemned by human rights organizations such as Amnesty International and remains unresolved, exemplifying the challenges of accountability and justice for abuses in conflict zones.",
"Mar 25, 2000",
"https://www.newsclick.in/pathribal-timeline-18-years-injustice",
"Pathribal Fake Encounter",
"Armed militants entered the village and lined up 24 Kashmiri Pandits and shot them dead.",
"The victims included 11 men, 11 women and 2 small boys, ranging in age from 2 years to 65 years.",
"The attackers were identified as members of the terrorist group from Pakistan-administered Kashmir.",
"The J&K High Court ordered the reopening of the case after years of stalled proceedings, aiming to ensure examination of witnesses and expedite the trial. However, many accused have either died or the case remains difficult to prosecute due to witness migration.",
"Mar 24, 2003",
"https://scroll.in/article/1037416/kashmiri-pandit-killings-nadimarg-massacre-trial-may-resume-but-those-accused-of-murder-are-dead",
"Nadimarg Massacre",
"Asiya Jan (17) and Neelofar Jan (22), residents of Shopian town in Kashmir, were abducted, gang-raped by multiple perpetrators and murdered. Their bodies were found the next day in a shallow stream, with forensic evidence and community statements confirming violent sexual assault as the cause of death.",
"There were complaints against police and administrative negligence, obstruction of justice, tampering with evidence and intimidation of the victims' families and witnesses.",
"A government inquiry led by retired Justice Muzaffar Jan confirmed the rape and murder, criticized the mishandling of the case by security forces and civil administration and recommended further investigations. However, the case remains tainted by accusations of cover-ups, slow legal procedures and lack of accountability for the perpetrators.",
"May 29, 2009",
"https://www.kljp.org/articles/militarization-with-impunity-a-brief-on-rape-and-murder-in-shopian-kashmir",
"Aasiya and Neelofar",
"The Machil Fake Encounter refers to an extrajudicial killing carried out by the Indian Army, in the Machil area of Kupwara district, Kashmir. Three Kashmiri civilians, Shazad Ahmad Khan (27), Shafi Ahmad Lone (19) and Riyaz Ahmad Lone (20), were killed and falsely labeled as Pakistani militants by the army. The victims were reportedly lured with a job promise by army sources and killed near the Line of Control (LoC) by soldiers of the 4 Rajputana Rifles. The army initially claimed to have prevented an infiltration attempt and alleged recovery of weapons from the killed militants, but police investigations revealed the victims were innocent civilians.",
"In 2014, five soldiers were convicted by a general court-martial for their involvement in the fake encounter. However, in 2017, a military tribunal suspended their life sentences and granted them bail, citing doubts about the evidence and the possibility that the victims could have been militants due to their attire and alleged arms recovery.",
"The Machil fake encounter sparked public outrage and intense media and human rights organization attention, including Amnesty International. Families of the victims continue to seek justice, while the case highlights issues of impunity, accountability and the challenges of securing fair trials for security personnel in conflict zones like Kashmir.",
"Apr 29, 2010",
"https://www.amnesty.org/en/latest/news/2014/11/india-convictions-indian-army-machil-fake-encounter-case-welcome-measure/",
...
"_CornerId.",
"maxValue",
"https://script.google.com/macros/s/AKfycbwVivdmtuhRW0Qx3VXleTv5gh5md8ofDwTU3whbCtJwp_oPwOD4CSUZSSxxY_RNgNaN/exec",
"https://script.google.com/macros/s/AKfycbyPdFbAqRIv-PkpSlKpNCzD1b0vUtbHc7avFdvYoFNZWTi7_Bpz_gy_MIMbA52i7-ET/exec",
"https://script.google.com/macros/s/AKfycbz0MxTCWe30MF3C2Jkt7jgA5QnUd8F8PPJzOlwnKbyRdhkMaOT3p9D0UVNDj8ZCIpaGXA/exec",
"Hw==",
"IA==",
"IQ==",
"Error fetching data: ",
...
"_labelAnimation",
"_thumbAnimation",
"assets/images/meaning.svg",
"assets/images/bottom_line.svg",
"Kaeshur: ",
"\nEnglish Meaning: ",
"Default",
"Norway",
...
"Thank you!\nYou have successfully submitted your word to 'Today's Words' section",
"Back to Home",
"SUCCESS",
"* Required",
"[!@#<>?\":_`~;[\\]\\\\|=+)(*&^%0-9-]",
...
"English: ",
"\nKaeshur: ",
"e.g خیال, abstraction, khaya:l",
"Search is filtered on both \nKashmiri as well as English Words",
"suggestions",
"results",
"_SearchBody.",
"No match found",
...
"_endingIndex",
"_icon",
"assets/images/add_word.svg",
"assets/images/theme.svg",
"e.g: hash, mother-in-law",
"Search for a Kashmiri word\nor type the English description",
" audio words",
"e.g sargaram, bird",
"selectedColor",
...
"is_online",
"dev.flutter.pigeon.firebase_remote_config_platform_interface.FirebaseRemoteConfigHostApi.setDefaults",
"Invalid value type \"",
"\" for key \"",
"\". ",
...
"Messaging#startBackgroundIsolate",
